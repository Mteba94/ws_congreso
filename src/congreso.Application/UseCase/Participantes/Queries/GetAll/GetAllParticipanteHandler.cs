...
internal sealed class GetAllParticipanteHandler(IUnitOfWork unitOfWork, IOrderingQuery orderingQuery, IFileLogger fileLogger) : IQueryHandler<GetAllParticipanteQuery, IEnumerable<ParticipantesResponseDto>>
{
    ...
    public async Task<BaseResponse<IEnumerable<ParticipantesResponseDto>>> Handle(GetAllParticipanteQuery query, CancellationToken cancellationToken)
    {
